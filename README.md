# Fork do [ConsertandoHorariosSIGAA](https://github.com/luthierycosta/ConsertandoHorariosSIGAA/), modificado para funcionar no sigaa.ufpb.br

# Consertando os Horários do SIGAA [![unb](images/unb_logo.png)](https://unb.br) (readme original)
